...
#st_write(trees_2013, "tree_objects_2013_las_intersection.shp")
#st_write(trees_2017, "tree_objects_2017_las_intersection.shp")
#st_write(trees_2018, "tree_objects_2018_las_intersection.shp")
#st_write(trees_2019, "tree_objects_2019_las_intersection.shp")
#st_write(trees_2021, "tree_objects_2021_las_intersection.shp")
