...
# Note, the test dataset held out until we select an index is 1-train_pct-valid_pct
train_pct <- 0.6 # train percentage
...
shps <- read_sf(paste0(sierra_dir,"/trees_2017_training_filtered_labeled.shp"))
...
print("Read in masks")
soap_mask <- raster(paste0(spectral_dir, "/tree_mask_SOAP_2017.tif"))
teak_mask <- raster(paste0(spectral_dir, "/tree_mask_TEAK_2017.tif"))
