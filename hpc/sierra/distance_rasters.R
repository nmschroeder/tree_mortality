...
# Local
data_dir <- "/Volumes/LaCie/roads_and_rivers"
out_dir <- "~/Documents/R/sierra_resilience/align_trees/data_layers"
ls_dir <- "/Volumes/LaCie/Landsat"
home_dir <- "~/Documents/R/sierra_resilience/align_trees"

# HPC3
data_dir <- "/dfs4/jranders_lab/users/hemmingn/sierra/landscape"
out_dir <- "/dfs4/jranders_lab/users/hemmingn/sierra/align_trees"
