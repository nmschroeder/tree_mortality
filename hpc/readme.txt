...
# indicate the version numbers of the software that we used.

# Each R file has a variable data_dir = "/path/to/your/data/directory/" which needs to be replaced
# by a home directory with a lot of storage space. Within this directory, we suggest the directory
# structure below. Items in /sierra are typically created throughout the algorithm, though there are # exceptions. 

## For storing data sets that are used in the algorithm
