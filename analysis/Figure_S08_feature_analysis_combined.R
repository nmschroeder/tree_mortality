...
vars <- c("mean_green", "zmax2013", "meank", "rgranite", "tpa", "cover", "slope", "d_rivers")
varnames <- c("Mean relative greenness", "2013 Height", "Mean distance 10 nearest trees (m)", "Fractional granite", "Trees per hectare", "Canopy cover fraction", "Slope", 
              "Distance from rivers")

# Restricted domain correlations
lb <- c(-1, 5, 0, 0, 0, 0, 0, 0)
ub <- c(1, 65, 40, 1, 300, 1, 60, 500)
...
ggsave("figures/Figure_S8_feature_panel_combined.pdf", plot = gsoap, width = 6.5, height = 9, unit = "in", dpi = 600)
